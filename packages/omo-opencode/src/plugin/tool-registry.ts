...
import {
  ...
  createSecondBrainToolsRecord,
  createTaskToolsRecord,
  createWebSearchToolsRecord,
...
export function createToolRegistry(args: {
  ...
  const { ctx, pluginConfig, managers, skillContext, availableCategories, interactiveBashEnabled = isInteractiveBashEnabled(), toolFactories } = args;
  ...
  const allTools = {
    ...
    ...createWebSearchToolsRecord({ pluginConfig, ctx }),
    ...createSecondBrainToolsRecord({ pluginConfig, ctx }),
  };
